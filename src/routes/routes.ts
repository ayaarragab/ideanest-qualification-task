...
import { validateInputSignup, validateInputSignin, validateRefreshToken, validateOrganization } from '../middlewares/validateInputs';
...
router.get('/organization/:organization_id', isAuthorized, getOrganization)
